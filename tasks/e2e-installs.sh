...
# ******************************************************************************
# First, pack and install create-accurapp.
# ******************************************************************************
...
exists node_modules/accurapp-scripts
...
# Check corresponding scripts version is installed.
exists node_modules/accurapp-scripts-fork
...
# ******************************************************************************
# Test --scripts-version with a scoped fork tgz of accurapp-scripts
# ******************************************************************************

cd $temp_app_path
curl "https://registry.npmjs.org/@enoah_netzach/accurapp-scripts/-/accurapp-scripts-0.9.0.tgz" -o enoah-scripts-0.9.0.tgz
...
# Check corresponding scripts version is installed.
exists node_modules/@enoah_netzach/accurapp-scripts
